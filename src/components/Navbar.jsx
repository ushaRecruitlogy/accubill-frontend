          ...
          <nav className="flex flex-col gap-4 mt-10 text-lg font-medium text-gray-700">
            ...
            <div className="relative group mt-4 ml-2 cursor-pointer text-sm text-gray-700 hover:text-[var(--bs-red)] transition w-max">
              ...
              <div className="absolute left-6 top-0 translate-x-full ml-4 invisible opacity-0 group-hover:visible group-hover:opacity-100 transition-all duration-200 bg-white shadow-md rounded-md p-4 w-40 z-50">
                <Link to="/blog" className="block text-sm hover:text-[var(--bs-blue)] mb-2" onClick={() => setOpen(false)}>
                  Blog
                </Link>
                <Link to="/community" className="block text-sm hover:text-[var(--bs-blue)] mb-2" onClick={() => setOpen(false)}>
                  Community
                </Link>
                <Link to="/support" className="block text-sm hover:text-[var(--bs-blue)] mb-2" onClick={() => setOpen(false)}>
                  Support
                </Link>
                <Link to="/contact" className="block text-sm hover:text-[var(--bs-blue)]" onClick={() => setOpen(false)}>
                  Contact Us
                </Link>
              </div>
            </div>
